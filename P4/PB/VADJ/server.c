...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(alias, "s01") == 0) {
        strcpy(ip_addr, "192.168.0.101");
        snprintf(save_dir, sizeof(save_dir), "%s/s01", getenv("HOME"));
    } else if (strcmp(alias, "s02") == 0) {
        strcpy(ip_addr, "192.168.0.102");
        snprintf(save_dir, sizeof(save_dir), "%s/s02", getenv("HOME"));
    } else if (strcmp(alias, "s03") == 0) {
	strcpy(ip_addr, "192.168.0.103");
	snprintf(save_dir, sizeof(save_dir), "%s/s03", getenv("HOME"));
    } else if (strcmp(alias, "s04") == 0) {
	strcpy(ip_addr, "192.168.0.104");
	snprintf(save_dir, sizeof(save_dir), "%s/s04", getenv("HOME"));
    } else {
